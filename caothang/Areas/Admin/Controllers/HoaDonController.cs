...
namespace caothang.Areas.Admin.Controllers
{
    ...
    public class HoaDonController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MaHD,MaKH,MaSP,TenSP,NgayLapHD,NgayNhanHang")] HoaDonModel hoaDonModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaHD,MaKH,MaSP,TenSP,NgayLapHD,NgayNhanHang")] HoaDonModel hoaDonModel)
        {
